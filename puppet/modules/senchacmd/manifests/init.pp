class senchacmd {
  ...
  $sencha_cmd_download = "http://cdn.sencha.com/cmd/$sencha_version/SenchaCmd-$sencha_version-linux.run.zip"
  $sencha_cmd_install = "SenchaCmd-$sencha_version-linux.run"
